  ...
  const plans = [
    {
      name: "Free",
      price: "$0",
      desc: "Use VoiceForge standard voices at no cost, forever.",
      features: [
        "Unlimited free voice generation",
        "VoiceForge standard voices",
        "Community support",
        "MP3 downloads",
    ...
    },
    {
      name: "Credits",
      price: "Pay as you go",
      desc: "Purchase credits and use premium VoiceForge voices.",
      features: [
        "Buy any amount — $1 to $100+",
        "Premium VoiceForge TTS voices",
      ...
      <main className="flex-1 flex flex-col items-center px-4 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-32">
        <div className="w-full max-w-container-max flex flex-col items-center">
           ...
           >
             ...
             <p className="text-base sm:text-lg text-on-surface-variant max-w-2xl leading-relaxed">Free voices forever. Pay-as-you-go credits for premium VoiceForge voices.</p>
           </motion.div>
           ...
           >
             ...
             <div className="flex flex-col gap-2.5">
               {[
                 ...
                 { q: "What is the difference between free and premium voices?", a: "Free voices use VoiceForge standard TTS and do not consume credits. Premium voices use VoiceForge TTS and produce significantly more natural, expressive speech — these deduct credits at 2 credits per character." },
