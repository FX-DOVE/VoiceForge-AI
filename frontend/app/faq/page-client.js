  ...
  const categories = [
    {
      ...
      questions: [
        ...
        },
        {
          ...
          a: "Yes! Every new account gets unlimited access to free VoiceForge standard voices at no cost, forever. Premium VoiceForge TTS voices require credits — no credit card required for the free tier.",
        },
      ],
    },
    {
      ...
      questions: [
        {
          ...
          a: "Credits power premium VoiceForge TTS generations. Each character costs 2 credits. You purchase credits in any amount from $1 to $100+. Credits never expire — they roll over indefinitely.",
        },
        {
