...
export default function FeaturesPage() {
  ...
  const sections = [
    {
      title: "xAI Powered Realism",
      desc: "Experience the pinnacle of artificial intelligence. Our xAI models understand context, ensuring every word is spoken with the exact right tone and emotion, completely eliminating the robotic feel of traditional text-to-speech.",
