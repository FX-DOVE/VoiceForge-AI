      ...
      <div className="flex flex-col min-h-full">
        ...
        <div className="flex flex-col lg:flex-row gap-8 items-start">
          ...
          <div className="flex-1 min-w-0 w-full space-y-5">
            ...
            <div className="glass-panel overflow-hidden border-white/10 rounded-2xl">
          ...
          <div className="w-full lg:w-[380px] lg:sticky lg:top-[80px] space-y-4">
            <div className="glass-panel flex flex-col border-white/10 rounded-2xl overflow-hidden" style={{ maxHeight: "calc(100vh - 160px)" }}>
              ...
              <div className="p-4 border-t border-white/5 bg-white/[0.02] space-y-3 shrink-0">
                ...
                {lastAudioUrl && (
                  <audio ref={generatedAudioRef} controls src={lastAudioUrl} autoPlay className="w-full rounded-xl h-10" />
                )}
                <div className="flex items-center justify-center gap-1.5 text-[11px] text-neutral-600">
                  <Info className="size-3 shrink-0" />
                  <span>~{(Math.ceil(count * 2)).toLocaleString()} credits · {count.toLocaleString()} chars</span>
                </div>
              </div>
            </div>
          </div>
