...
const config = {
  ...
  xai: {
    ...
    ttsUrl: process.env.XAI_TTS_URL || "https://api.x.ai/v1/audio/speech",
    model: process.env.XAI_MODEL || "grok-tts-beta",
    defaultVoiceId: process.env.XAI_DEFAULT_VOICE_ID || "Aria",
